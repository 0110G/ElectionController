...
@RestController
public final class ChangeTitleOperation extends ActionController<ChangeElectionTitleQuery, Response> {

    private static final ControllerOperation ACTION = ControllerOperation.CHANGE_ELECTION_TITLE;
